...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="rightbox">
                <div class="profile">
                    <form method="post" action="./../../controlleur/controlleur_user.php?action=modify_profil">
                    <h1>Personal Info</h1>
                    <h4>First name</h4>
                    ...
                    <h4>Date of birth</h4>
                    <input type="text" name="date_of_birth" class="input" value="<?php echo $_SESSION['date_of_birth']; ?>">
                    <h4>Gender</h4>
