    ...
    class view_doctor{
        ...
        public function my_consultations($consultations) {     
            foreach($consultations as $consultation){
                ...
                <div class="article">
                    <div class="left">
                        <img src="../view/view_doctor/img.png">
                    </div>
                    <div class="right">
                        ...
                        <p class="statut">'.$consultation['statut'].'</p>
                            <div class="more">
                                <a class="btn1" href="controlleur_doctor.php?action=see&id_question='.$consultation['id'].'">See more</a>
                                <a class="btn2" href="../view/view_doctor/answer.php?id_question='.$consultation['id'].'">Answer</a>
                                <a class="btn3" href="controlleur_doctor.php?action=see_profil&patient='.$consultation['patient'].'">See patient profil</a>    
                            </div>
                        </div>
                </div>';
            }
