<?php
    class view_consultations{
        ...
        public function consultations($consultations){
            foreach($consultations as $consultation){
                $this->content.='<tr>
                                    <td>'.$consultation['Post'].'</td>
                                    <td>'.$consultation['patient'].'</td>
                                    <td>'.$consultation['type'].'</td>
                                    <td><a href="controlleur_admin.php?action=delete_consultation&id_consultation='.$consultation['id'].'" class="btn">delete</a></td>
                                </tr>';                    
            }
        }
