    ...
    class view_doctors{
        ...
        public function __construct($title) {
            ...
            <section class="home">
                ...
                <div class="add">
                    <a href="../view/view_admin/add_doctor.php"><i class="bx bx-plus"></i>doctor</a>
                </div> 
                <h1 class="tab">All doctors</h1>
                <div class="table">
                    <table>
                        <div class="color">
                            <thead>
        ...
        public function doctors($doctors){
            foreach($doctors as $doctor){
                $this->content.='<tr>
                                    ...
                                    <td>'.$doctor['sexe'].'</td>
                                    <td>'.$doctor['name_of_cathegory'].'</td>
                                    <td><a href="controlleur_admin.php?action=delete_doctor&id_doctor='.$doctor['id_doctor'].'" class="btn">delete</a></td>
                                </tr>';
