    ...
    class view_maladies{
        ...
        public function __construct($title) {
            ...
            <section class="home">
                ...
                <div class="add">
                    <a href="../view/view_admin/add_maladie.php"><i class="bx bx-plus"></i>maladie</a>
                </div>
                <h1>All maladies</h1>
                <div class="table">
                    <table>
        ...
        public function maladies($maladies){
            foreach($maladies as $maladie){
                $this->content.='<tr>
                                    ...
                                    <td><a href="controlleur_admin.php?action=delete_maladie&id_maladie='.$maladie['id_maladie'].'" class="btn">delete</a></td>
                                </tr>';
