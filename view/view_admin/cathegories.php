    ...
    class view_cathegories{
        ...
        public function __construct($title) {
            ...
            <section class="home">
                ...
                <div class="add">
                    <a href="../view/view_admin/add_cathegorie.php"><i class="bx bx-plus"></i>categorie</a>
                </div>
        ...
        public function cathegories($cathegories){
            foreach($cathegories as $cathegorie){
                $this->content.='<tr>
                                    <td>'.$cathegorie['id_cathegory'].'</td>
                                    <td>'.$cathegorie['name_of_cathegory'].'</td>
                                    <td><a href="controlleur_admin.php?action=delete_cathegorie&id_cathegorie='.$cathegorie['id_cathegory'].'" class="btn">delete</a></td>
                                </tr>';
